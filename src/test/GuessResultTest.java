...
class GuessResultTest {
    ...
    public void testgetGuessResult(){
        ...
        String guess = "BRAIN";
        String answer = "BASIC";
        LetterResult[] guessResult = {LetterResult.GREEN, LetterResult.GRAY, LetterResult.YELLOW,LetterResult.GREEN, LetterResult.GRAY};
        assertEquals(guessResult,GuessResult.getGuessResult());
    }
